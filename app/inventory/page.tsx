      ...
      >
        ...
        <CardContent>
                      ...
                      <TableCell>
                        <div className="flex flex-col gap-1">
                          <span className="font-medium">
                            {item.currentStock}{item.unit} ({stockPercent}%)
                          </span>
          ...
          <p className="mt-4 text-sm text-muted-foreground">
            총 {filteredAndSortedItems.length}개 품목
          </p>
        </CardContent>
      </Card>
      ...
      <Dialog open={isDeleteConfirmOpen} onOpenChange={setIsDeleteConfirmOpen}>
        <DialogContent className="sm:max-w-sm">
          <DialogHeader>
            ...
            <DialogDescription>
              정말로 <span className="font-medium text-foreground">{selectedItem?.product}</span> 품목을 삭제하시겠습니까? 이 작업은 되돌릴 수 없습니다.
            </DialogDescription>
          </DialogHeader>
      ...
      <Dialog open={isAddOpen} onOpenChange={setIsAddOpen}>
        <DialogContent className="sm:max-w-md">
          ...
          <DialogFooter>
            ...
            <Button onClick={handleAddItem} disabled={!addForm.product}>
              추가
            </Button>
          </DialogFooter>
        </DialogContent>
